                ...
                <table class="table table-hover ">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">PROJ_LOC</th>
                            <th scope="col">BUDGET</th>
                            <th scope="col">PROJ_LEAD</th>
                    ...
                    <tbody>
                        <?php
                            ...
                            <tr>
                                ...
                                <td><?php echo $row["PROJ_LOC"]; ?></td>
                                <td><?php echo $row["BUDGET"]; ?></td>
                                <td><?php echo $row["PROJ_LEAD"]; ?></td>
                                <td><?php echo $row["NO_OF_EMP"]; ?></td>
                                <td><?php echo $row["TOTAL_RATING"]; ?></td>
                                <td><?php echo $row["DURATION"]; ?></td>
                                <td><a href="Update.php?PROJ_ID=<?php echo $row["PROJ_ID"]; ?>"><button type="button" class="btn btn-info">UPDATE</button></a></td>
                                <td><a href="Del.php?PROJ_ID=<?php echo $row["PROJ_ID"]; ?>"><button type="button" class="btn btn-danger">DELETE</button></a></td>
                            </tr>
                        <?php
                                $i++;
                            }
