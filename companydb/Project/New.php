...
// prepare and bind
$stmt = $conn->prepare("INSERT INTO PROJECT (PROJ_ID ,PROJ_NAME ,DEP_NO ,PROJ_LOC ,BUDGET ,PROJ_LEAD, NO_OF_EMP , TOTAL_RATING , DURATION) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
$stmt->bind_param("isisisiis", $PROJ_ID, $PROJ_NAME, $DEP_NO,$PROJ_LOC,$BUDGET,$PROJ_LEAD,$NO_OF_EMP,$TOTAL_RATING,$DURATION);
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div id="content">
                    <h1>NEW ENTRY DONE SUCCESSFULY</h1>
                </div>
            </div>
        </div>
    </div>
