...
mysqli_query($conn, "UPDATE project set PROJ_NAME='" . $_POST['PROJ_NAME'] . "', DEP_NO='" . $_POST['DEP_NO'] . "', PROJ_LOC='" . $_POST['PROJ_LOC'] . "', BUDGET='" . $_POST['BUDGET'] . "' ,PROJ_LEAD='" . $_POST['PROJ_LEAD'] . "' ,NO_OF_EMP='" . $_POST['NO_OF_EMP'] . "',TOTAL_RATING='" . $_POST['TOTAL_RATING'] . "',DURATION='" . $_POST['DURATION'] . "'WHERE PROJ_ID='" . $_POST['PROJ_ID'] . "'");
mysqli_close($conn);
?>
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div id="content">
                    <h1>RECORD UPDATED SUCCESSFULY</h1>
                </div>
            </div>
        </div>
    </div>
