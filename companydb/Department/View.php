                ...
                <table class="table table-hover ">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">NO_OF_EMP</th>
                            <th scope="col">DEP_MANAGER</th>
                            <th scope="col">DEP_LOC</th>
                            <th scope="col">NO_OF_PROJ</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                            ...
                            <tr>
                                ...
                                <td><?php echo $row["DEP_MANAGER"]; ?></td>
                                <td><?php echo $row["DEP_LOC"]; ?></td>
                                <td><?php echo $row["NO_OF_PROJECT"]; ?></td>
                                <td><a href="Update.php?DEP_NO=<?php echo $row["DEP_NO"]; ?>"><button type="button" class="btn btn-info">UPDATE</button></a></td>
                                <td><a href="Del.php?DEP_NO=<?php echo $row["DEP_NO"]; ?>"><button type="button" class="btn btn-danger">DELETE</button></a></td>
                            </tr>
                        <?php
                                $i++;
                            }
