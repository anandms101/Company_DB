...
mysqli_query($conn, "UPDATE department set NO_OF_PROJECT='" . $_POST['NO_OF_PROJECT'] . "', DEP_NAME='" . $_POST['DEP_NAME'] . "', NO_OF_EMP='" . $_POST['NO_OF_EMP'] . "', DEP_MANAGER='" . $_POST['DEP_MANAGER'] . "' ,DEP_LOC='" . $_POST['DEP_LOC'] . "' WHERE DEP_NO='" . $_POST['DEP_NO'] . "'");
mysqli_close($conn);
?>
