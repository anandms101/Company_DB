...
// prepare and bind
$stmt = $conn->prepare("INSERT INTO DEPARTMENT (DEP_NO,DEP_NAME,NO_OF_EMP,DEP_MANAGER,DEP_LOC,NO_OF_PROJECT) VALUES (?, ?, ?, ?, ?, ?)");
$stmt->bind_param("isissi", $DEP_NO, $DEP_NAME, $NO_OF_EMP,$DEP_MANAGER,$DEP_LOC,$NO_OF_PROJECT);
...
$NO_OF_PROJECT = $_POST["NO_OF_PROJECT"];
$stmt->execute();
