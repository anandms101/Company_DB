...
mysqli_query($conn, "UPDATE employee set E_MAIL='" . $_POST['E_MAIL'] . "', NAME='" . $_POST['NAME'] . "', ADDRESS='" . $_POST['ADDRESS'] . "', PH_NO='" . $_POST['PH_NO'] . "' ,DOB='" . $_POST['DOB'] . "' ,PROOF_NAME='" . $_POST['PROOF_NAME'] . "',PROOF_ID='" . $_POST['PROOF_ID'] . "',DEP_NO='" . $_POST['DEP_NO'] . "'WHERE EMP_ID='" . $_POST['EMP_ID'] . "'");
mysqli_close($conn);
?>
