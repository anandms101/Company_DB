...
<body>
   ...
   <div class="container">
        <form action="Update1.php" method="POST">
            <div class="heading">PERFORMANCE NEW ENTRY</div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="formGroupExampleInput" name="PROJ_ID" placeholder="PROJ ID">
            </div>
            <div class="form-group">
                <label for="formGroupExampleInput">STARS</label>
                <input type="text" class="form-control" id="formGroupExampleInput" name="STARS" placeholder="STARS">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="formGroupExampleInput" name="COMMENTS"
