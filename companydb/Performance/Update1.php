...
mysqli_query($conn, "UPDATE performance set PROJ_ID='" . $_POST['PROJ_ID'] . "', STARS='" . $_POST['STARS'] . "', DEP_NO='" . $_POST['DEP_NO'] . "', COMMENTS='" . $_POST['COMMENTS'] . "'  WHERE EMP_ID='" . $_POST['EMP_ID'] . "'");
mysqli_close($conn);
?>
