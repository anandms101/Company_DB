...
$conn->query("CALL CalcHike()");
// selection of table
$result = mysqli_query($conn, "SELECT * FROM calc");
?>
                ...
                <table class="table table-hover ">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">OLD_SAL</th>
                            <th scope="col">NEW_SAL</th>
                    ...
                    <tbody>
                        <?php
                            ...
                            <tr>
                                ...
                                <td><?php echo $row["OLD_SAL"]; ?></td>
                                <td><?php echo $row["NEW_SAL"]; ?></td>
                                <td><?php echo $row["HIKE"]; ?></td>
                            </tr>
                        <?php
                                $i++;
                            }
