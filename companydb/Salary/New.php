...
// prepare and bind
$stmt = $conn->prepare("INSERT INTO SALARY (EMP_ID ,BASIC_PAY ,BONUS,DATE_OF_SAL ,TOTAL_PAY ,REIMBURSEMENT,PENALTY) VALUES (?, ?, ?, ?, ?, ?,?)");
$stmt->bind_param("iiisiii", $EMP_ID, $BASIC_PAY, $BONUS, $DATE_OF_SAL, $TOTAL_PAY, $REIMBURSEMENT , $PENALTY);

// set parameters and execute
$EMP_ID = $_POST["EMP_ID"];
$BASIC_PAY = $_POST["BASIC_PAY"];
$BONUS = $_POST["BONUS"];
$DATE_OF_SAL = $_POST["DATE_OF_SAL"];
