...
mysqli_query($conn, "UPDATE salary set BASIC_PAY='" . $_POST['BASIC_PAY'] . "', BONUS='" . $_POST['BONUS'] . "', DATE_OF_SAL='" . $_POST['DATE_OF_SAL'] . "', TOTAL_PAY='" . $_POST['TOTAL_PAY'] . "' ,REIMBURSEMENT='" . $_POST['REIMBURSEMENT'] . "' WHERE EMP_ID='" . $_POST['EMP_ID'] . "'");
mysqli_close($conn);
?>
